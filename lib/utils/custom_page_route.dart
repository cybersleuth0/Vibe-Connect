...
class SlideUpPageRoute extends PageRouteBuilder {
  ...
  SlideUpPageRoute({required this.child, RouteSettings? settings})
      : super(
    settings: settings,
    transitionDuration: const Duration(milliseconds: 300),
    reverseTransitionDuration: const Duration(milliseconds: 300),
...
class RotationPageRoute extends PageRouteBuilder {
  ...
  RotationPageRoute({required this.child, RouteSettings? settings})
      : super(
    settings: settings,
...
class SlideFadePageRoute extends PageRouteBuilder {
  ...
  SlideFadePageRoute({required this.child, RouteSettings? settings})
      : super(
    settings: settings,
...
class SharedAxisPageRoute extends PageRouteBuilder {
  ...
  SharedAxisPageRoute({required this.child, RouteSettings? settings})
      : super(
    settings: settings,
